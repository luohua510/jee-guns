...
import hh.jee.guns.lang.Editor;
import hh.jee.guns.lang.Filter;
import hh.jee.guns.lang.Matcher;
import hh.jee.guns.bean.BeanUtil;
import hh.jee.guns.lang.collection.ArrayIter;
import hh.jee.guns.lang.collection.BoundedPriorityQueue;
import hh.jee.guns.lang.collection.EnumerationIter;
import hh.jee.guns.lang.collection.IteratorEnumeration;
import hh.jee.guns.lang.comparator.PinyinComparator;
import hh.jee.guns.lang.comparator.PropertyComparator;
import hh.jee.guns.lang.convert.Convert;
import hh.jee.guns.lang.convert.ConverterRegistry;
import hh.jee.guns.lang.exception.UtilException;
import hh.jee.guns.lang.function.Func1;
import hh.jee.guns.lang.hash.Hash32;
 ...
 * <p>
 * 由于{@link Collection} 实现了{@link Iterable}接口，因此部分工具此类不提供，而是在{@link IteratorUtil} 中提供
 *
...
public class CollectionUtil {
	 ...
	 * @param collection 集合
	 * @return {@link Map}
	 * @see IteratorUtil#countMap(Iterator)
	 */
	public static <T> Map<T, Integer> countMap(Iterable<T> collection) {
		return IteratorUtil.countMap(null == collection ? null : collection.iterator());
	}
	...
	public static <T extends Collection<E>, E> T filter(T collection, final Filter<E> filter) {
		return IteratorUtil.filter(collection, filter);
	}
	...
	public static <K, V> Map<K, V> fieldValueMap(Iterable<V> iterable, String fieldName) {
		return IteratorUtil.fieldValueMap(null == iterable ? null : iterable.iterator(), fieldName);
	}
	...
	public static <K, V> Map<K, V> fieldValueAsMap(Iterable<?> iterable, String fieldNameForKey, String fieldNameForValue) {
		return IteratorUtil.fieldValueAsMap(null == iterable ? null : iterable.iterator(), fieldNameForKey, fieldNameForValue);
	}
	 ...
	 * @return 是否为空
	 * @see IteratorUtil#isEmpty(Iterable)
	 */
	public static boolean isEmpty(Iterable<?> iterable) {
		return IteratorUtil.isEmpty(iterable);
	}
	 ...
	 * @return 是否为空
	 * @see IteratorUtil#isEmpty(Iterator)
	 */
	 ...
	 * @param iterable Iterable对象
	 * @return 是否为空
	 * @see IteratorUtil#isNotEmpty(Iterable)
	 */
	public static boolean isNotEmpty(Iterable<?> iterable) {
		return IteratorUtil.isNotEmpty(iterable);
	}
	 ...
	 * @param Iterator Iterator对象
	 * @return 是否为空
	 * @see IteratorUtil#isNotEmpty(Iterator)
	 */
	public static boolean isNotEmpty(Iterator<?> Iterator) {
		return IteratorUtil.isNotEmpty(Iterator);
	}
	 ...
	 * @see IteratorUtil#hasNull(Iterable)
	 */
	public static boolean hasNull(Iterable<?> iterable) {
		return IteratorUtil.hasNull(iterable);
	}
	 ...
	 * @return Map
	 * @see IteratorUtil#toMap(Iterable)
	 */
	public static <K, V> HashMap<K, V> toMap(Iterable<Entry<K, V>> entryIter) {
		return IteratorUtil.toMap(entryIter);
	}
	 ...
	 * @see IteratorUtil#asIterator(Enumeration)
	 */
	public static <E> Iterator<E> asIterator(Enumeration<E> e) {
		return IteratorUtil.asIterator(e);
	}
	 ...
	 * @see IteratorUtil#asIterable(Iterator)
	 */
	...
	public static <K, V> Map<K, V> toMap(Iterable<V> values, Map<K, V> map, Func1<V, K> keyFunc) {
		return IteratorUtil.toMap(null == values ? null : values.iterator(), map, keyFunc);
	}
	...
	public static <K, V, E> Map<K, V> toMap(Iterable<E> values, Map<K, V> map, Func1<E, K> keyFunc, Func1<E, V> valueFunc) {
		return IteratorUtil.toMap(null == values ? null : values.iterator(), map, keyFunc, valueFunc);
	}
	...
	public static <T> Collection<T> addAll(Collection<T> collection, Object value, Type elementType) {
		...
		if (value instanceof Iterator) {
			...
			// 其它类型按照单一元素处理
			iter = CollectionUtil.newArrayList(value).iterator();
		}
	 ...
	 * @param iterable {@link Iterable}
	 * @return 第一个元素
	 * @see IteratorUtil#getFirst(Iterable)
	 */
	public static <T> T getFirst(Iterable<T> iterable) {
		return IteratorUtil.getFirst(iterable);
	}
	 ...
	 * @param iterator {@link Iterator}
	 * @return 第一个元素
	 * @see IteratorUtil#getFirst(Iterator)
	 */
	public static <T> T getFirst(Iterator<T> iterator) {
		return IteratorUtil.getFirst(iterator);
	}
	 ...
	 * @see IteratorUtil#getElementType(Iterable)
	 */
	public static Class<?> getElementType(Iterable<?> iterable) {
		return IteratorUtil.getElementType(iterable);
	}
	 ...
	 * @param iterator {@link Iterator}
	 * @return 元素类型，当列表为空或元素全部为null时，返回null
	 * @see IteratorUtil#getElementType(Iterator)
	 */
	public static Class<?> getElementType(Iterator<?> iterator) {
		return IteratorUtil.getElementType(iterator);
	}
