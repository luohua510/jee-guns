...
import hh.jee.guns.io.resource.ResourceUtil;
import hh.jee.guns.lang.Assert;
import hh.jee.guns.lang.ClassScanner;
import hh.jee.guns.lang.Filter;
import hh.jee.guns.lang.Singleton;
import hh.jee.guns.lang.convert.BasicType;
...
public class ClassUtil {
	...
	/**
	 * 获取完整类名的短格式如：<br>
	 * cn.hutool.core.util.StringUtil -》c.h.c.u.StringUtil
	 *
	 * @param className 类名
	 * @return 短格式类名
	 */
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，类名与方法名用<code>.</code>或<code>#</code>连接 例如：com.xiaoleilu.hutool.StringUtil.isEmpty 或 com.xiaoleilu.hutool.StringUtil#isEmpty
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.xiaoleilu.hutool.StringUtil#isEmpty或com.xiaoleilu.hutool.StringUtil.isEmpty
