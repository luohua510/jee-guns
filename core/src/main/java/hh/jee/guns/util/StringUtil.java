...
import hh.jee.guns.lang.Assert;
import hh.jee.guns.lang.Matcher;
import hh.jee.guns.lang.comparator.VersionComparator;
import hh.jee.guns.lang.convert.Convert;
import hh.jee.guns.lang.function.Func1;
import hh.jee.guns.lang.text.StrBuilder;
import hh.jee.guns.lang.text.StrFormatter;
import hh.jee.guns.lang.text.StrSpliter;
import hh.jee.guns.lang.text.TextSimilarity;
...
public class StringUtil {
	 ...
	 *
	 * <pre>
	 * StringUtil.subSufByLength("abcde", 3)      =    "cde"
	 * StringUtil.subSufByLength("abcde", 0)      =    ""
	 * StringUtil.subSufByLength("abcde", -5)     =    ""
	 * StringUtil.subSufByLength("abcde", -1)     =    ""
	 * StringUtil.subSufByLength("abcde", 5)       =    "abcde"
	 * StringUtil.subSufByLength("abcde", 10)     =    "abcde"
	 * StringUtil.subSufByLength(null, 3)               =    null
	 * </pre>
	 *
	 * @param string 字符串
	 * @param length 切割长度
	 ...
	 *
	 * <pre>
	 * StringUtil.subBetweenAll("wx[b]y[z]", "[", "]") 		= ["b","z"]
	 * StringUtil.subBetweenAll(null, *, *)          			= []
	 * StringUtil.subBetweenAll(*, null, *)          			= []
	 * StringUtil.subBetweenAll(*, *, null)          			= []
	 * StringUtil.subBetweenAll("", "", "")          			= []
	 * StringUtil.subBetweenAll("", "", "]")         			= []
	 * StringUtil.subBetweenAll("", "[", "]")        			= []
	 * StringUtil.subBetweenAll("yabcz", "", "")     			= []
	 * StringUtil.subBetweenAll("yabcz", "y", "z")   			= ["abc"]
	 * StringUtil.subBetweenAll("yabczyabcz", "y", "z")   		= ["abc","abc"]
	 * StringUtil.subBetweenAll("[yabc[zy]abcz]", "[", "]");   = ["zy"]           重叠时只截取内部，
	 * </pre>
	 *
	 * @param str    被切割的字符串
	 ...
	 *
	 * <pre>
	 * StringUtil.repeatAndJoin("?", 5, ",")   = "?,?,?,?,?"
	 * StringUtil.repeatAndJoin("?", 0, ",")   = ""
	 * StringUtil.repeatAndJoin("?", 5, null) = "?????"
	 * </pre>
	 *
	 * @param str         被重复的字符串
	 * @param count       数量
	 ...
	 *
	 * <pre>
	 * StringUtil.padPre(null, *, *);//null
	 * StringUtil.padPre("1", 3, "ABC");//"AB1"
	 * StringUtil.padPre("123", 2, "ABC");//"12"
	 * </pre>
	 *
	 * @param str       字符串
	 ...
	 *
	 * <pre>
	 * StringUtil.padAfter(null, *, *);//null
	 * StringUtil.padAfter("1", 3, '0');//"100"
	 * StringUtil.padAfter("123", 2, '0');//"23"
	 * </pre>
	 *
	 ...
	 * <pre>
	 * StringUtil.padAfter(null, *, *);//null
	 * StringUtil.padAfter("1", 3, "ABC");//"1AB"
	 * StringUtil.padAfter("123", 2, "ABC");//"23"
	 * </pre>
	 *
	 * @param str       字符串，如果为<code>null</code>，按照空串处理
	 * @param minLength 最小长度
	 ...
	 *
	 * <pre>
	 * StringUtil.compareVersion(null, "v1") &lt; 0
	 * StringUtil.compareVersion("v1", "v1")  = 0
	 * StringUtil.compareVersion(null, null)   = 0
	 * StringUtil.compareVersion("v1", null) &gt; 0
	 * StringUtil.compareVersion("1.0.0", "1.0.2") &lt; 0
	 * StringUtil.compareVersion("1.0.2", "1.0.2a") &lt; 0
	 * StringUtil.compareVersion("1.13.0", "1.12.1c") &gt; 0
	 * StringUtil.compareVersion("V0.0.20170102", "V0.0.20170101") &gt; 0
	 * </pre>
	 *
	 * @param version1 版本1
	 * @param version2 版本2
