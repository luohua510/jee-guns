package hh.jee.guns.io;

import hh.jee.guns.io.file.*;
import hh.jee.guns.io.file.FileReader;
import hh.jee.guns.io.file.FileWriter;
...
public class FileUtil {
	...
	public static String getAbsolutePath(String path, Class<?> baseClass) {
		...
		if (null != url) {
			// 对于jar中文件包含file:前缀，需要去掉此类前缀，在此做标准化
